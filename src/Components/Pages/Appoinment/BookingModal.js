...
<div class="modal modal-bottom sm:modal-middle">
  ...
  <label for="bookingModal" class="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
    ...
    <form onSubmit={handleBookig} className='grid grid-cols-1 gap-3 mx-auto mt-3 justify-items-center'>
    ...
    <select name='slot' class="select select-bordered w-full max-w-xs">
  {
    ...
    <input type="submit" value="Submit" class="btn btn-secondary font-bold w-full max-w-xs text-white" />
